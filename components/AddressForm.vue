<template>
    <form class="flex flex-col gap-2" @submit.prevent="onSubmit">
        ...
        <div class="flex justify-between gap-2">
            <text-input class="w-5/12" label="Zip code*" :value="zipCode" field="zipCode" id="zipCode"
                @change="onChangeText" type="text" />
            <text-input class="w-5/12" label="City*" :value="city" field="city" id="city" @change="onChangeText"
                type="text" />
        </div>
