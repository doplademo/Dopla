<template>
	<section class="flex flex-col items-start bg-redLightest px-4 pt-12 pb-4 lg:flex-row lg:items-center lg:px-24 lg:py-16 lg:gap-8 lg:justify-center">
		<div class="flex flex-col items-start max-w-2xl">
			<h2 class="heading-two">Tulee luoksesi</h2>
			<p class="p-large text-blackBold mt-4 mb-8">
